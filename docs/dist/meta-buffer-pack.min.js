...
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */const w=new TextEncoder,b=new TextDecoder,B=E;function E(t,e=0){let r;if(void 0===t||"string"!=typeof t||"number"!=typeof e)throw TypeError("invlaid init variablie type name. ");return(t=t.toUpperCase()).includes("8")?(r=d.Buffer.alloc(1),t.includes("I")?r.writeInt8(e):r.writeUint8(e)):t.includes("16")?(r=d.Buffer.alloc(2),t.includes("I")?t.includes("L")?r.writeInt16LE(e):r.writeInt16BE(e):t.includes("L")?r.writeUint16LE(e):r.writeUint16BE(e)):t.includes("32")?(r=d.Buffer.alloc(4),t.includes("I")?t.includes("L")?r.writeInt32LE(e):r.writeInt32BE(e):t.includes("L")?r.writeUint32LE(e):r.writeUint32BE(e)):t.includes("N")?r=d.Buffer.from(String(e)):console.log(`invalid type: ${t} or initvalue: ${e}`),r}const m=A;function A(t,e,r){let n,i="B";if("number"==typeof e)r?(n=d.Buffer.alloc(e),n.fill(r),i="B"):(n=d.Buffer.from(String(e)),i="N");else if("string"==typeof e&&"number"==typeof r)i=e.toUpperCase(),n=E(e,r);else if("string"==typeof e&&void 0===r)n=d.Buffer.from(e),i="S";else if(e instanceof Uint8Array&&void 0===r)n=e instanceof d.Buffer?e:d.Buffer.from(e);else if(e instanceof ArrayBuffer&&void 0===r)n=d.Buffer.from(e);else if(ArrayBuffer.isView(e))n=d.Buffer.from(e.buffer,e.byteOffset,e.byteLength);else if("object"==typeof e&&void 0===r)n=d.Buffer.from(JSON.stringify(e)),i="O";else if("boolean"==typeof e&&void 0===r){let t=e?1:0;n=d.Buffer.from([t]),i="!"}return"string"==typeof t&&t.includes("#")&&(t=""),[t,i,n]}const I=U;function U(...t){let e=0,r=t.map((t=>{let r=e++;return"number"==typeof t?m(r,"N",t):m(r,t)}));return r.push(m("$","8",r.length)),r}function v(t,e,r,n){if(t.includes("8"))return t.includes("I")?e.readInt8(r):e.readUint8(r);if(t.includes("16"))return t.includes("I")?t.includes("L")?e.readInt16LE(r):e.readInt16BE(r):t.includes("L")?e.readUint16LE(r):e.readUint16BE(r);if(t.includes("32"))return t.includes("I")?t.includes("L")?e.readInt32LE(r):e.readInt32BE(r):t.includes("L")?e.readUint32LE(r):e.readUint32BE(r);if("B"===t)return e.slice(r,r+n);if("S"===t){let t=e.slice(r,r+n);return b.decode(t)}if("N"===t){let t=e.slice(r,r+n);return Number(b.decode(t))}if("O"!==t){if("!"===t){return 1===e.readInt8(r)}throw TypeError("invalid data")}{let t=e.slice(r,r+n);try{return JSON.parse(b.decode(t))}catch(t){console.log("err. obj parse")}}}const L=O;function O(t,e=!1){if(null==t)throw"Invalid data type: Undefined";if("string"==typeof t)return w.encode(t);if("number"==typeof t)return Uint8Array.from([t]);if(t instanceof ArrayBuffer){if(e)return new Uint8Array(t);{let e=new Uint8Array(t),r=new Uint8Array(t.byteLength);return r.set(e),r}}if(ArrayBuffer.isView(t)){if(e)return new Uint8Array(t.buffer,t.byteOffset,t.byteLength);{let e=new Uint8Array(t.buffer,t.byteOffset,t.byteLength),r=new Uint8Array(t.byteLength);return r.set(e),r}}return w.encode(JSON.stringify(t))}const R=T;function T(t,e=!1){const r=O(t,e);return d.Buffer.from(r)}const S=_;function _(...t){try{let e=0,r=0,n=t.map((t=>T(t)));n.forEach((t=>{e+=t.byteLength}));let i=d.Buffer.alloc(e);return n.forEach((t=>{i.set(t,r),r+=t.byteLength})),i}catch(t){console.log(t)}}const N=C;function C(...t){try{let e=0,r=0,n=t.map((t=>O(t)));n.forEach((t=>{e+=t.byteLength}));let i=new Uint8Array(e);return n.forEach((t=>{i.set(t,r),r+=t.byteLength})),i}catch(t){console.log(t)}}var x=Object.freeze({__proto__:null,Buffer:d.Buffer,NB:B,numberBuffer:E,MB:m,metaBuffer:A,MBA:I,metaBufferArguments:U,readTypedBuffer:v,pack:function(...t){let e,r,n=function(t){let e=[];return t.filter((t=>{if(!Array.isArray(t[0]))return t;e=e.concat(t)})).concat(e)}(t),i=0,o=[],f=0;n.forEach((t=>{let[e,r,n]=t;i+=n.byteLength,("number"==typeof e||e.length>0)&&(r.includes("N")||r.includes("B")||r.includes("S")||r.includes("O")?o.push([e,r,f,n.byteLength]):o.push([e,r,f])),f=i})),o.length>0&&(e=w.encode(JSON.stringify(o)),r=e.byteLength,i=i+r+2);let u=d.Buffer.alloc(i);if(f=0,n.forEach((t=>{let e=t[2];u.set(e,f),f+=e.byteLength})),o.length>0){u.set(e,f);let t=B("16",r);return u.set(t,f+r),u}return u},unpack:function(t){try{let e=d.Buffer.from(t),r=e.readUInt16BE(e.byteLength-2),n=e.byteLength-r-2,i=e.subarray(n,e.byteLength-2),o=b.decode(i),f=JSON.parse(o),u={};if(f.forEach((t=>{let[r,n,i,o]=t;u[r]=v(n,e,i,o)})),u.$){let t=u.$,e=[];for(let r=0;r<t;r++)e.push(u[r]);u.args=e,u.$=u.args}return u}catch(t){}},U8:L,parseUint8Array:O,B8:R,parseBuffer:T,B8pack:S,parseBufferThenConcat:_,U8pack:N,parseUint8ThenConcat:C,hex:function(t){return Array.prototype.map.call(new Uint8Array(t),(t=>("00"+t.toString(16)).slice(-2))).join("")},equal:function(t,e){if(t.byteLength!=e.byteLength)return!1;for(let r=0;r<t.byteLength;r++)if(t[r]!=e[r])return!1;return!0}});return x}();
